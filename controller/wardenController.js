...
exports.getWardensByHostel = async (req, res) => {
  try {
    ...
    const wardens = await Warden.find({ assignedHostel: hostelId })
      .populate('assignedHostel', 'hostelName hostelCode')
      .select('wardenName email mobileNumber gender shift status');
