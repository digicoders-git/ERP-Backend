...
exports.getProfile = async (req, res) => {
  try {
    ...
    res.status(200).json({
      success: true,
      data: { id: admin._id, email: admin.email, role: admin.role, status: admin.status, createdAt: admin.createdAt }
    });
  } catch (error) {
...
// UPDATE profile (only email update allowed for superAdmin)
